    ...
    public class EdmLoader
    {
        ...
        public static void Main(string[] args)
        {
            var model = ReadModel(@"C:\repos\fun\lab\ApiAsAService\EdmHelperTest\NW_Simple.xml");
             GetComplexTypes(model, "NW_Simple");
        ...
        public static void GetComplexTypes(IEdmModel model, string assemblyName = "NorthWind_Simple")
        {
            var assemblyFullName = assemblyName + ".DataModels.dll";
            ...
            var moduleBuilder = assemblyBuilder.DefineDynamicModule("Modules" + ".mod", assemblyFullName
                , false);
